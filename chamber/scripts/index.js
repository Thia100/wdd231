...
// const apiKey = 'ec1534ef72dab5cce496e92dee471474';
// const weatherUrl = `https://api.openweathermap.org/data/2.5/forecast?lat=7.79&lon=4.53&appid=${apiKey}&units=imperial`;
...
//     const days = ['Today', 'Thursday', 'Friday'];
//     const forecastDays = [0, 3, 4]; 

//     forecastDays.forEach((dayIndex) => {
//         const forecastData = data.list.filter(item => {
//             const itemDate = new Date(item.dt * 1000);
//             return itemDate.getDay() === (today.getDay() + dayIndex) % 7 && itemDate.getHours() === 12; // Get the forecast for 12 PM
//         });
...
//             temp.innerHTML = `<strong>Temperature:</strong> ${forecastData[0].main.temp}°F`;

//             const weatherDesc = document.createElement('p');
//             weatherDesc.innerHTML = `<strong>Description:</strong> ${forecastData[0].weather[0].description}`;
